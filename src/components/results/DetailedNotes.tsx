...
import { ChevronDown, ChevronUp, BookOpen, Lightbulb, Download } from "lucide-react";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";
import { exportDetailedNotes } from "@/lib/exportPdf";
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <Button
          variant="outline"
          size="sm"
          onClick={() => exportDetailedNotes(notes)}
          className="gap-2"
        >
